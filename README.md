...
## Prompt
> Act as a senior program developer in Ateneo de Davao University. Using my javascript framework VUE js, you are task to convert. You are tasked to convert the mobile application into a desktop website. I will be sending screenshots of the figma prototype along with its flow. The design must be same as the mobile app screenshots from the google document.
